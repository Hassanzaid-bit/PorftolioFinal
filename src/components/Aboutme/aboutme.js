    ...
    return ( 
        <div className="about-me text-left my-28">
            <div class="personal-details">
                ...
                <p className="text-2x1 font-medium">Hi, I’m Hassan Zaid. I’m a Web Developer, Web Designer, working remotely from Nairobi, Kenya.
            ...
            <div class="personal-skills text-sm font-normal my-6">
                ...
                <div class="skillset">
                    ...
                    <h4 className="text-3xl font-semibold">React</h4>
                        <p className="text-2xl font-medium">My favoutite javascript library for creating Single Page Applications</p>
                    </div>

                    <div className="my-5">
                    <h4 className="text-3xl font-semibold">Django</h4>
                        <p className="text-2xl font-medium">What i use for my backend</p>
                    </div>
                </div>
